...
// | 47-Segment in memory | (46-45)-Ring | 44-System/DataCode Descriptor | 43-data/code segment | 42-Expansion | 41-r/w | 40-Access bit |
//! set access bit
...
// | 55/7-Granularity | 54/6-Segment Type | 53/5- | 52/4- | (51-48/3-0)-Segment Limit Hi |
...
struct gdt_descriptor {
	...
	uint16_t		baseLo;             // bit 16-31
	uint8_t			baseMid;            // bit 32-39

	//! descriptor access flags
	uint8_t			flags;              // bit 40-47: | 7-Segment in memory | 65-Ring | 4-System/DataCode Descriptor | 3-data/code | 2-Expansion | 1-r/w | 0-Access bit |

	uint8_t			grand;              // bit 48-55: | 55/7-Granularity | 54/6-Segment Type | 53/5- | 52/4- | (51-48/3-0)-Segment Limit Hi |
